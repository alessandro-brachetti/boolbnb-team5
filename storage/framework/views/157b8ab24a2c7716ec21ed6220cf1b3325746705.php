...
<div class="container-fluid advanced-search-page" id="search" >
    <div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12 mobile d-flex flex-wrap flex-column justify-content-between">
            <h4 class="mt-3">Soggiorni nell'area selezionata della mappa</h4>
            <div id="filters" class="d-flex flex-wrap flex-column mt-3 mb-3">
                
                <div class="first-line-filters d-flex flex-wrap justify-content-start mb-3">
                    <div class="mr-2">
                    ...
                    <button class="filter-services-btn" type="button" data-toggle="modal" data-target="#myModal">Più filtri</button>
                </div>
