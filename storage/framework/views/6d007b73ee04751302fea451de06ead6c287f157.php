...
unset($__errorArgs, $__bag); ?>" id="address" type="text" name="address" placeholder="Clicca per recuperare l'indirizzo" @input="responseApi" @click="getAddress('<?php echo e($apartment->address); ?>','<?php echo e($apartment->longitude); ?>','<?php echo e($apartment->latitude); ?>')">
                  <ul class="results">
...
unset($__errorArgs, $__bag); ?>" id="<?php echo e($service->service_name); ?>" type="checkbox" name="service_ids[]" value=" <?php echo e($service->id); ?>" <?php echo e($apartment->services->contains($service) ?  'checked' : ''); ?>>
                <label class="form-check-label" for="services"><span><img class="icon" src="/icons/<?php echo e($service->service_name); ?>.svg" alt=""></span><span><?php echo e($service->service_name); ?></span></label>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Alessandro\Desktop\Esercizi\boolbnb-team5\resources\views/admin/apartments/edit.blade.php ENDPATH**/ ?>